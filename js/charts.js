jQuery(document).ready(function() {
    ...
    var piedata = [
        { label: "华东地区", data: [[1,10]], color: '#D9534F'},
        { label: "华北地区", data: [[1,30]], color: '#1CAF9A'},
        { label: "华南地区", data: [[1,90]], color: '#F0AD4E'},
        { label: "西南地区", data: [[1,70]], color: '#428BCA'},
        { label: "西北地区", data: [[1,80]], color: '#5BC0DE'}
	 ];
